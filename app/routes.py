...
from app.utils import generate_short_code, get_qr_data_url, generate_qr, select_rotate_target, get_geo_info, is_safe_url, get_client_ip, _get_redis_client, get_blocked_domains, is_safe_redirect_url
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and check_password_hash(user.password_hash, form.password.data):
            ...
            return redirect(next_page) if next_page and is_safe_redirect_url(next_page) else redirect(url_for('main.index'))
        else:
