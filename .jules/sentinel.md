...
## 2026-05-27 - Remove Unused Imports in API
**Optimization:** Removed unused imports `base64` and `generate_qr` from `app/api.py`.
**Learning:** Regular code cleanup using linters like `ruff` helps maintain a lean namespace and prevents dependency bloat.
**Prevention:** Integrate linting checks into the CI/CD pipeline to catch unused imports and other code smells automatically.
